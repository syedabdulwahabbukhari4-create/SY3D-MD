        ...
        buttons: [
          {
            ...
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.youtube || 'http://youtube.com/@devilxofficial_hackers'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.github || 'coming soon'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: 'https://whatsapp.com/channel/0029Vb79zv13mFY8wJw14h1T'
            })
          }
        ]
      }, { quoted: msg });
